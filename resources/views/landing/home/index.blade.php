      ...
      <section class="section hero" id="home">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-text">
                Selamat datang di Ruang Obat, platform digital yang mempermudah Anda untuk mencari, membeli, dan mendapatkan informasi seputar obat dengan cepat dan praktis.
                Kami menghadirkan layanan yang aman dan terpercaya, didukung oleh apotek resmi dan tenaga ahli farmasi untuk memenuhi kebutuhan kesehatan Anda.
            </p>

             <a href="https://wa.me/6281331419120" class="btn btn-login" target="_blank" style="width: 40%;">Contact Kami</a>
          </div>
    ...
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-text">
           Ruang Obat adalah platform yang menyediakan berbagai macam obat dengan harga terjangkau.
          </p>
        </div>
