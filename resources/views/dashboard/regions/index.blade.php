                            ...
                            <tbody>
                                @foreach ($provinces as $province)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard.regions.edit', $province->id) }}"
                                                class="btn btn-warning">Edit</a>
                                            <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDeleteProvince{{ $province->id }}">Hapus</button>
                                        </td>
                                    </tr>

                                    <!-- Modal Delete Province -->
                                    <div class="modal fade" id="modalDeleteProvince{{ $province->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body text-center py-4">
                                                    ...
                                                    <div class="text-muted">Data yang dihapus tidak dapat dikembalikan.
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <div class="w-100">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <form
                                                                    action="{{ route('dashboard.regions.destroy', $province->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
