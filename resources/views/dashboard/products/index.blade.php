                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list d-flex">
                        ...
                        <a href="#" class="btn btn-danger d-sm-none btn-icon" data-bs-toggle="modal"
                            data-bs-target="#modalAdd" aria-label="Tambah Produk">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="24"
                                height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                <a class="avatar me-2 img-preview cursor-pointer"
                                                    data-fslightbox="product-{{ $product->id }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <button class="btn btn-icon btn-pill bg-muted-lt ms-1"
                                                    ...
                                                    <div class="text-muted dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <button class="dropdown-item btn-action-delete"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="icon icon-tabler me-2" width="24"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('url') is-invalid @enderror"
                                    name="url" placeholder="URL Produk" value="{{ old('url') }}">
                                @error('url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <select class="form-select @error('is_published') is-invalid @enderror"
                                    name="is_published">
                                    <option value="" disabled selected>Pilih</option>
                                    <option value="1" {{ old('is_published') == '1' ? 'selected' : '' }}>Aktif
                                    </option>
                                    <option value="0" {{ old('is_published') == '0' ? 'selected' : '' }}>Tidak Aktif
                                    </option>
                                </select>
                                @error('is_published')
                                    <div class="invalid-feedback">
